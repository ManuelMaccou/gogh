    ...
    const fetchTransactions = async () => {
      ...
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BASE_URL}/api/user/purchases`,
          {
            ...
            <div key={transaction._id} className="product-row">
              <div className="profile-product-details">
                <div className="profile-product-image">
                  <img
                    src={transaction.marketplaceProduct.featuredImage}
                    alt="Product"
                ...
                <div className="profile-product-text">
                  ...
                  <p className="product-description">
                    {transaction.marketplaceProduct.description
                      .split("\n")
              ...
              <div className="escrow-details">
                ...
                <p className="escrow-status-description">
                ...
                <div className="escrow-decision">
                  <div className="cancel-escrow">
                    <p>
                      ...
                      <span
                        ...
                        data-tooltip="You can cancel your purchase after it's been held in escrow for over a week. This is protect you from unresponsive sellers. Your money will be returned to you immediately."
                      >
                      ...
                      onClick={async () => {
                        try {
                          const {
                            ...
                            signer,
                            goghContract,
                          } = await warmUpEtherDetails();
                          const res = await cancelEscrow({
                          ...
                          console.error(
                            "Unexpected error in cancel escrow:",
                            error
                          );
                          alert(
                  ...
                  <div className="confirm-item-transfer">
                    <p>
                      ...
                      <span
                        className="tooltip-icon"
                        data-tooltip="If you've successfully received your item, finalize the purchase."
                      >
                        <i className="fa-solid fa-circle-info"></i>
                      </span>
                    </p>
                    <button
                      onClick={async () => {
                        try {
                          ...
                          console.error(
                            "Unexpected error in release escrow:",
                            error
                          );
                          alert(
                            "An unexpected error occurred. Please try again."
